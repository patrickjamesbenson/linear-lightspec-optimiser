...
st.title("Linear Lightspec Optimiser v4.4")
...
if st.session_state['ies_files']:
    ...
    # === DISPLAY IES METADATA & PARAMETERS ===
    ...
    # === PARSE AND DISPLAY LUMCAT LOOKUP ===
    ...
    if lumcat_input:
        ...
        with st.expander("🔎 LumCAT Reverse Lookup (from Matrix)", expanded=False):
            if lumcat_desc:
                ...
                st.warning("⚠️ No LumCAT code found or Matrix lookup failed.")

else:
    st.info("📄 Please upload an IES file to start.")

# === FOOTER ===
st.caption("Version 4.4 - Full Base Info + Matrix Lookup ✅")
